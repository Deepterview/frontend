  ...
  return (
    ...
    >
      ...
      <p className="max-w-[672px] text-lg font-light leading-7 tracking-[0.5px] text-[#cbc3d7] sm:text-xl">
        Instantly adjust non-verbal behaviors including facial expressions, eye
        contact, and tone to optimize your interview performance in real-time.
      </p>
